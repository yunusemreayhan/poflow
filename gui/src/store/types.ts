// --- Types ---
// Extracted from api.ts for cleaner separation (Q6)
...
export interface BurnSummaryEntry { date: string; username: string; points: number; hours: number; count: number; }
export interface BurnTotalEntry { task_id: number; total_points: number; total_hours: number; count: number; }
export interface TaskAssignee { task_id: number; user_id: number; username: string; }
