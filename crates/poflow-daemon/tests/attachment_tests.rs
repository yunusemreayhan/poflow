...
async fn test_attachments_crud() {
    ...
    let resp = app
        ...
        .oneshot(auth_req(
            ...
            "/api/tasks",
            &tok,
            Some(json!({"title":"WithAttachment"})),
        ))
        .await
        .unwrap();
    ...
    let resp = app
        ...
        .oneshot(auth_req(
            "GET",
            &format!("/api/tasks/{}/attachments", tid),
            &tok,
            None,
        ))
        .await
    ...
    let resp = app
        ...
        .oneshot(auth_req(
            "GET",
            &format!("/api/attachments/{}/download", att_id),
            &tok,
            None,
        ))
        .await
...
async fn test_attachment_delete_ownership() {
    ...
    let resp = app
        ...
        .oneshot(json_req(
            "POST",
            "/api/auth/register",
            Some(json!({"username":"other","password":"Other123"})),
        ))
        .await
        .unwrap();
...
async fn test_attachment_cycle() {
    ...
    let resp = app
        ...
        .oneshot(auth_req(
            "GET",
            &format!("/api/attachments/{}/download", aid),
            &tok,
            None,
        ))
        .await
